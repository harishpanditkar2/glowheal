        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Have questions? We're here to help. Send us a message via email or WhatsApp and we'll respond within 24 hours.
            </p>
          </div>
              ...
              <div className="border-t-2 border-gray-200 pt-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-3 bg-lime-400 hover:bg-lime-500 text-forest-900 font-semibold py-4 px-6 rounded-xl transition-colors focus:outline-none focus:ring-2 focus:ring-forest-700 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-3 bg-green-600 hover:bg-green-700 text-white font-semibold py-4 px-6 rounded-xl transition-colors focus:outline-none focus:ring-2 focus:ring-green-700"
                  >
          ...
          <div className="mt-12 bg-forest-50 rounded-xl p-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <a href="/book" className="inline-flex items-center gap-2 bg-lime-400 hover:bg-lime-500 text-forest-900 font-semibold py-2 px-4 rounded-lg transition-colors">
                  Book Now
