      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="inline-flex items-center gap-2 bg-jade-400 text-white px-6 py-3 rounded-lg shadow-md">
      ...
      <section className="py-16 bg-gradient-to-br from-teal-600 to-amber-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/book">
              <Button variant="primary" size="lg" className="bg-white text-jade-700 hover:bg-jade-50">
                ?? Book Free Consultation
              </Button>
            </Link>
