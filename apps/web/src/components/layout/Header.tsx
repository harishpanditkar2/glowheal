                ...
                <div className="absolute left-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-200 py-2 z-50">
                  {CITIES.map((cityOption) => {
                    ...
                    return (
                      <button
                        key={cityOption.slug}
                        onClick={() => handleCityChange(cityOption.slug)}
                        className={`w-full text-left px-4 py-3 hover:bg-jade-50 transition-colors flex items-center justify-between ${
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className={`text-sm font-semibold ${isSelected ? 'text-forest-900' : 'text-gray-900'}`}>
                              {cityOption.name}
                            </div>
                            {status === 'coming-soon' && (
                              <div className="text-xs text-amber-600 mt-0.5">
                                Coming Soon • Showing Pune prices
                              </div>
                            )}
                          </div>
                        </div>
